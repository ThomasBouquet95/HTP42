...
// Admin: printable (Save-as-PDF) summary of a staffing's logged timesheets.
// Mirrors the member-side /summary/print styling so both look the same and
// carry the HTP42 header — the browser's print dialog produces the PDF.
